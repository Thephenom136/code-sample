...
class TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.lines = ["Add John 4111111111111111 $1000", "Charge John $500", "Credit John $100"]
 
    def test_add(self):
        expected_clients_limits = {'John': 1000}
        expected_clients_accounts = {'John': 0}
    ...
    def test_charge(self):
        expected_clients_limits = {'John': 1000}
        expected_clients_accounts = {'John': 500}
    ...
    def test_credit(self):
        expected_clients_limits = {'John': 1000}
        expected_clients_accounts = {'John': 400}
